...
//     } else {
    ...
    if (preg_match('/^[a-zA-Z0-9]*$/', $nom)) {
        ...
        if($traitement) {
           $sth->fetchAll();
            ...
            if($sth->rowCount() == 0) {
                ...
                if(!$traitement) {
                    header('Location: ./creation.php?message=erreur');
                } else {
                    header('Location: ./connexion.php?message=succes');
                }
            } else {
                header('Location: ./creation.php?message=utilisateurExisteDeja');
            }
        } else {
        ...
        header('Location: ./creation.php?message=utilisateurIncorrect');
    }
}
?>